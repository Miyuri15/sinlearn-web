...
export default function Sidebar({ chats = [] }: SidebarProps) {
  ...
  return (
    <div className="w-80 h-screen border-r bg-white flex flex-col">
      <div className="p-4 text-lg font-semibold">Chat History</div>
      ...
      <div className="px-4 pb-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full border rounded-lg pl-10 pr-3 py-2 text-sm outline-none focus:ring-2 focus:ring-gray-300"
          />
        </div>
      </div>
      ...
      <div className="px-4 space-y-2">
        <button
          ...
          className="w-full flex items-center gap-3 border rounded-lg px-3 py-2 hover:bg-gray-100 transition"
        >
