  ...
  return (
    <div className="rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden bg-white dark:bg-slate-900">
      ...
      <button
        ...
        className="w-full p-4 bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-950/30 dark:to-blue-950/30 hover:from-indigo-100 hover:to-blue-100 dark:hover:from-indigo-900/40 dark:hover:to-blue-900/40 transition-all duration-200 cursor-pointer group"
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-shrink-0 text-slate-400 group-hover:text-slate-600 dark:text-slate-500 dark:group-hover:text-slate-300 transition-colors">
            {isExpanded ? (
      ...
      {/* Expanded Details */}
      {isExpanded && (
        <div className="border-t border-slate-200 dark:border-slate-700 animate-in slide-in-from-top-2 duration-200">
          {/* Sources Section */}
          {explanation.chunk_contributions &&
                ...
                <div className="p-4 space-y-4 bg-amber-50/50 dark:bg-amber-950/20">
                  ...
                  {flaggedDetails.length > 0 && (
                    <div className="space-y-3">
                      ...
                      {displayedFlagged.map(
                        (detail: SafetyDetail, idx: number) => (
                          <div
                            key={idx}
